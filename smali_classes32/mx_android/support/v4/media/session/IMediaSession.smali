.class public interface abstract Lmx_android/support/v4/media/session/IMediaSession;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lmx_android/support/v4/media/session/IMediaSession$Stub;
    }
.end annotation
...
.method public abstract getMetadata()Lmx_android/support/v4/media/MediaMetadataCompat;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getPlaybackState()Lmx_android/support/v4/media/session/PlaybackStateCompat;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getVolumeAttributes()Lmx_android/support/v4/media/session/ParcelableVolumeInfo;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract rate(Lmx_android/support/v4/media/RatingCompat;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract registerCallbackListener(Lmx_android/support/v4/media/session/IMediaControllerCallback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract sendCommand(Ljava/lang/String;Landroid/os/Bundle;Lmx_android/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract unregisterCallbackListener(Lmx_android/support/v4/media/session/IMediaControllerCallback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
