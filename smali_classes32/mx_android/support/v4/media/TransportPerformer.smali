.class public abstract Lmx_android/support/v4/media/TransportPerformer;
...
.method public onAudioFocusChange(I)V
    ...
    invoke-virtual {p0, p1, v10}, Lmx_android/support/v4/media/TransportPerformer;->onMediaButtonDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1, v10}, Lmx_android/support/v4/media/TransportPerformer;->onMediaButtonUp(ILandroid/view/KeyEvent;)Z
...
.method public onMediaButtonDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 132
    :cond_0
    invoke-virtual {p0}, Lmx_android/support/v4/media/TransportPerformer;->onPause()V

    return v0

    .line 129
    :cond_1
    invoke-virtual {p0}, Lmx_android/support/v4/media/TransportPerformer;->onStart()V

    return v0

    .line 135
    :cond_2
    invoke-virtual {p0}, Lmx_android/support/v4/media/TransportPerformer;->onStop()V

    return v0

    .line 139
    :cond_3
    invoke-virtual {p0}, Lmx_android/support/v4/media/TransportPerformer;->onIsPlaying()Z
