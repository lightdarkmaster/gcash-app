.class public Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;
.super Ljava/lang/Object;
.source "NotificationCompatJellybean.java"

# interfaces
.implements Lmx_android/support/v4/app/NotificationBuilderWithBuilderAccessor;
.implements Lmx_android/support/v4/app/NotificationBuilderWithActions;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lmx_android/support/v4/app/NotificationCompatJellybean;
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v5, v0, Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;->mActionExtrasList:Ljava/util/List;
    ...
    iput-object v1, v0, Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;->b:Landroid/app/Notification$Builder;
    ...
    iput-object v1, v0, Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
    ...
    const-string v2, "mx_android.support.localOnly"
    ...
    const-string v2, "mx_android.support.groupKey"
    ...
    const-string v2, "mx_android.support.isGroupSummary"
    ...
    :cond_6
    const-string v2, "mx_android.support.useSideChannel"
    ...
    const-string v2, "mx_android.support.sortKey"
...
# virtual methods
.method public addAction(Lmx_android/support/v4/app/NotificationCompatBase$Action;)V
    .locals 2

    .line 124
    iget-object v0, p0, Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;->mActionExtrasList:Ljava/util/List;

    iget-object v1, p0, Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;->b:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Lmx_android/support/v4/app/NotificationCompatJellybean;->writeActionAndGetExtras(Landroid/app/Notification$Builder;Lmx_android/support/v4/app/NotificationCompatBase$Action;)Landroid/os/Bundle;
...
.method public build()Landroid/app/Notification;
    ...
    .line 133
    iget-object v0, p0, Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;->b:Landroid/app/Notification$Builder;
    ...
    .line 136
    invoke-static {v0}, Lmx_android/support/v4/app/NotificationCompatJellybean;->getExtras(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v3, p0, Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
    ...
    .line 144
    iget-object v1, p0, Lmx_android/support/v4/app/NotificationCompatJellybean$Builder;->mActionExtrasList:Ljava/util/List;

    invoke-static {v1}, Lmx_android/support/v4/app/NotificationCompatJellybean;->buildActionExtrasMap(Ljava/util/List;)Landroid/util/SparseArray;
