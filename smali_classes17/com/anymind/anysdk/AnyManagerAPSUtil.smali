.class public Lcom/anymind/anysdk/AnyManagerAPSUtil;
...
.method public static createAdMobBannerRequestBundle(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .line 5
    :try_start_0
    invoke-static {p0}, Lcom/amazon/device/ads/DTBAdUtil;->createAdMobBannerRequestBundle(Ljava/lang/String;)Landroid/os/Bundle;
...
.method public static createAdMobBannerRequestBundle(Ljava/lang/String;II)Landroid/os/Bundle;
    ...
    .line 1
    :try_start_0
    invoke-static {p0, p1, p2}, Lcom/amazon/device/ads/DTBAdUtil;->createAdMobBannerRequestBundle(Ljava/lang/String;II)Landroid/os/Bundle;
...
.method public static createAdMobBannerRequestBundle(Ljava/lang/String;IILjava/util/Map;)Landroid/os/Bundle;
    ...
    .line 3
    :try_start_0
    invoke-static {p0, p1, p2, p3}, Lcom/amazon/device/ads/DTBAdUtil;->createAdMobBannerRequestBundle(Ljava/lang/String;IILjava/util/Map;)Landroid/os/Bundle;
...
.method public static createAdMobBannerRequestBundle(Ljava/lang/String;Ljava/util/Map;)Landroid/os/Bundle;
    ...
    .line 7
    :try_start_0
    invoke-static {p0, p1}, Lcom/amazon/device/ads/DTBAdUtil;->createAdMobBannerRequestBundle(Ljava/lang/String;Ljava/util/Map;)Landroid/os/Bundle;
...
.method public static createAdMobInterstitialRequestBundle(Ljava/lang/String;Ljava/util/Map;)Landroid/os/Bundle;
    ...
    .line 3
    :try_start_0
    invoke-static {p0, p1}, Lcom/amazon/device/ads/DTBAdUtil;->createAdMobInterstitialRequestBundle(Ljava/lang/String;Ljava/util/Map;)Landroid/os/Bundle;
...
.method public static createAdMobInterstitialVideoRequestBundle(Ljava/lang/String;Ljava/util/Map;)Landroid/os/Bundle;
    ...
    .line 3
    :try_start_0
    invoke-static {p0, p1}, Lcom/amazon/device/ads/DTBAdUtil;->createAdMobInterstitialVideoRequestBundle(Ljava/lang/String;Ljava/util/Map;)Landroid/os/Bundle;
...
.method public static getAPSAdMobCustomEventClass()Ljava/lang/Class;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    :try_start_0
    const-class v0, Lcom/amazon/admob_adapter/APSAdMobCustomEvent;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
