.class Lly/img/android/pesdk/backend/model/state/HistoryState$c;
...
.method private constructor <init>(Lly/img/android/pesdk/backend/model/state/HistoryState;Landroid/os/Parcel;)V
    ...
    .line 10
    iget-object v2, p0, Lly/img/android/pesdk/backend/model/state/HistoryState$c;->a:Ljava/util/HashMap;
...
.method synthetic constructor <init>(Lly/img/android/pesdk/backend/model/state/HistoryState;Landroid/os/Parcel;Lly/img/android/pesdk/backend/model/state/HistoryState$a;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lly/img/android/pesdk/backend/model/state/HistoryState$c;-><init>(Lly/img/android/pesdk/backend/model/state/HistoryState;Landroid/os/Parcel;)V
...
.method synthetic constructor <init>(Lly/img/android/pesdk/backend/model/state/HistoryState;Lly/img/android/pesdk/backend/model/state/HistoryState$a;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Lly/img/android/pesdk/backend/model/state/HistoryState$c;-><init>(Lly/img/android/pesdk/backend/model/state/HistoryState;)V

    return-void
.end method

.method static synthetic a(Lly/img/android/pesdk/backend/model/state/HistoryState$c;Landroid/os/Parcel;I)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2}, Lly/img/android/pesdk/backend/model/state/HistoryState$c;->i(Landroid/os/Parcel;I)V

    return-void
.end method

.method static synthetic b(Lly/img/android/pesdk/backend/model/state/HistoryState$c;Lly/img/android/pesdk/backend/model/state/manager/StateHandler;)V
    .locals 1
    ...
    invoke-direct {p0, p1}, Lly/img/android/pesdk/backend/model/state/HistoryState$c;->f(Lly/img/android/pesdk/backend/model/state/manager/StateHandler;)V

    return-void
.end method

.method static synthetic c(Lly/img/android/pesdk/backend/model/state/HistoryState$c;)Ljava/util/HashMap;
    .locals 1
    ...
    iget-object p0, p0, Lly/img/android/pesdk/backend/model/state/HistoryState$c;->a:Ljava/util/HashMap;

    return-object p0
.end method

.method private f(Lly/img/android/pesdk/backend/model/state/manager/StateHandler;)V
    .locals 2
...
.method private i(Landroid/os/Parcel;I)V
    .locals 3
...
# virtual methods
.method protected d(Ljava/lang/Class;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected e(Lly/img/android/pesdk/backend/model/state/HistoryState$c;)Z
    .locals 3
...
.method public g(Ljava/lang/Class;Lly/img/android/pesdk/backend/model/state/manager/Settings$SaveState;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
