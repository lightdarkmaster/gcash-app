...
.method static constructor <clinit>()V
    ...
    const-string v1, "307049"

    invoke-static/range {v1 .. v1}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "307050"
    ...
    invoke-direct {v0, v2, v3, v1}, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v2, "307051"

    invoke-static/range {v2 .. v2}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string v4, "307052"
    ...
    invoke-direct {v1, v4, v5, v2}, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    new-instance v2, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;

    const-string v4, "307053"

    invoke-static/range {v4 .. v4}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    const-string v6, "307054"
    ...
    invoke-direct {v2, v6, v7, v4}, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v2, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;->POSTROLL:Lcom/iab/omid/library/smartadserver1/adsession/media/Position;

    new-instance v4, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;

    const-string v6, "307055"

    invoke-static/range {v6 .. v6}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    const-string v8, "307056"
    ...
    invoke-direct {v4, v8, v9, v6}, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v4, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;->STANDALONE:Lcom/iab/omid/library/smartadserver1/adsession/media/Position;

    const/4 v6, 0x4

    new-array v6, v6, [Lcom/iab/omid/library/smartadserver1/adsession/media/Position;
    ...
    sput-object v6, Lcom/iab/omid/library/smartadserver1/adsession/media/Position;->$VALUES:[Lcom/iab/omid/library/smartadserver1/adsession/media/Position;
