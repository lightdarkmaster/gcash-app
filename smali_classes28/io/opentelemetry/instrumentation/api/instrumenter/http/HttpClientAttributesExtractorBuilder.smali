...
.field final getter:Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesGetter;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesGetter;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 15
    .line 16
    iput-object p1, p0, Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesExtractorBuilder;->getter:Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesGetter;
...
.method public build()Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesExtractor;
    ...
    iget-object v1, p0, Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesExtractorBuilder;->getter:Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesGetter;

    iget-object v2, p0, Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesExtractorBuilder;->capturedRequestHeaders:Ljava/util/List;

    iget-object v3, p0, Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesExtractorBuilder;->capturedResponseHeaders:Ljava/util/List;

    invoke-direct {v0, v1, v2, v3}, Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesExtractor;-><init>(Lio/opentelemetry/instrumentation/api/instrumenter/http/HttpClientAttributesGetter;Ljava/util/List;Ljava/util/List;)V
