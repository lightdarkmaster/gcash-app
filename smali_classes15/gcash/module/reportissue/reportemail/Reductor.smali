.class public Lgcash/module/reportissue/reportemail/Reductor;
...
.method static constructor <clinit>()V
    ...
    const-class v1, Lgcash/module/reportissue/reportemail/Reductor;
    ...
    sput-object v0, Lgcash/module/reportissue/reportemail/Reductor;->SET_EMAIL:Ljava/lang/String;
...
.method public constructor <init>(Lcom/yheriatovych/reductor/Reducer;Lcom/yheriatovych/reductor/Reducer;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lgcash/module/reportissue/reportemail/Reductor;->a:Lcom/yheriatovych/reductor/Reducer;

    .line 5
    .line 6
    iput-object p2, p0, Lgcash/module/reportissue/reportemail/Reductor;->b:Lcom/yheriatovych/reductor/Reducer;
...
# virtual methods
.method public reduce(Lgcash/module/reportissue/reportemail/State;Lcom/yheriatovych/reductor/Action;)Lgcash/module/reportissue/reportemail/State;
    .locals 4
    ...
    .line 3
    invoke-static {}, Lgcash/module/reportissue/reportemail/State;->builder()Lgcash/module/reportissue/reportemail/State$Builder;

    move-result-object p1

    invoke-virtual {p1}, Lgcash/module/reportissue/reportemail/State$Builder;->build()Lgcash/module/reportissue/reportemail/State;

    move-result-object p1

    .line 4
    :cond_2
    iget-object v0, p0, Lgcash/module/reportissue/reportemail/Reductor;->a:Lcom/yheriatovych/reductor/Reducer;

    invoke-virtual {p1}, Lgcash/module/reportissue/reportemail/State;->getScreenState()Lgcash/common/android/application/util/redux/screen/ScreenState;
    ...
    .line 5
    iget-object v1, p0, Lgcash/module/reportissue/reportemail/Reductor;->b:Lcom/yheriatovych/reductor/Reducer;

    invoke-virtual {p1}, Lgcash/module/reportissue/reportemail/State;->getMessageDialogState()Lgcash/common/android/application/util/redux/messagedialog/MessageDialogState;
    ...
    sget-object v3, Lgcash/module/reportissue/reportemail/Reductor;->SET_EMAIL:Ljava/lang/String;
    ...
    sget-object v3, Lgcash/common/android/application/util/validator/Rules;->EMAIL:Lgcash/common/android/application/util/validator/ValidatorManager$Rule;
    ...
    .line 17
    invoke-virtual {v2, v0}, Lgcash/module/reportissue/reportemail/State$Builder;->setScreenState(Lgcash/common/android/application/util/redux/screen/ScreenState;)Lgcash/module/reportissue/reportemail/State$Builder;

    move-result-object v0

    .line 18
    invoke-virtual {v0, v1}, Lgcash/module/reportissue/reportemail/State$Builder;->setMessageDialogState(Lgcash/common/android/application/util/redux/messagedialog/MessageDialogState;)Lgcash/module/reportissue/reportemail/State$Builder;

    move-result-object v0

    .line 19
    invoke-virtual {v0, p1}, Lgcash/module/reportissue/reportemail/State$Builder;->setEmail(Ljava/lang/String;)Lgcash/module/reportissue/reportemail/State$Builder;
    ...
    :goto_0
    invoke-virtual {p1, v0}, Lgcash/module/reportissue/reportemail/State$Builder;->setValidity(Lgcash/common/android/application/util/EValidity;)Lgcash/module/reportissue/reportemail/State$Builder;
    ...
    invoke-virtual {p1, p2}, Lgcash/module/reportissue/reportemail/State$Builder;->setValidityMessage(Ljava/lang/String;)Lgcash/module/reportissue/reportemail/State$Builder;
...
.method public bridge synthetic reduce(Ljava/lang/Object;Lcom/yheriatovych/reductor/Action;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lgcash/module/reportissue/reportemail/Reductor;->reduce(Lgcash/module/reportissue/reportemail/State;Lcom/yheriatovych/reductor/Action;)Lgcash/module/reportissue/reportemail/State;
