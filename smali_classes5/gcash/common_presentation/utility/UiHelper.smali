.class public Lgcash/common_presentation/utility/UiHelper;
...
.method public static createQRCode(Ljava/lang/String;Landroid/widget/ImageView;II)V
    ...
    .line 14
    invoke-static {p0, p1, p2, p3}, Lgcash/common_presentation/utility/UiHelper;->createQRCode(Ljava/lang/String;Landroid/widget/ImageView;Landroid/graphics/Bitmap;I)V
...
.method public static createQRCode(Ljava/lang/String;Landroid/widget/ImageView;Landroid/graphics/Bitmap;I)V
    ...
    .line 11
    invoke-static {p2, p0}, Lgcash/common_presentation/utility/UiHelper;->mergeBitmaps(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method public static setBarcode(Ljava/lang/String;Landroid/widget/ImageView;)V
    ...
    .line 9
    invoke-static {p0, p1, v0, v1}, Lgcash/common_presentation/utility/UiHelper;->setBarcode(Ljava/lang/String;Landroid/widget/ImageView;II)V
...
.method public static setBarcode(Ljava/lang/String;Landroid/widget/ImageView;II)V
    ...
    .line 1
    :try_start_0
    invoke-static {p2}, Lgcash/common_presentation/utility/UiHelper;->getDipDimension(F)F
    ...
    .line 2
    invoke-static {p3}, Lgcash/common_presentation/utility/UiHelper;->getDipDimension(F)F
...
.method public static setBgImageView(Landroid/content/Context;ILandroid/widget/ImageView;)V
    ...
    new-instance p1, Lgcash/common_presentation/utility/UiHelper$c;

    invoke-direct {p1, p2}, Lgcash/common_presentation/utility/UiHelper$c;-><init>(Landroid/widget/ImageView;)V
...
.method public static setBgImageView(Landroid/content/Context;Landroid/graphics/drawable/Drawable;Landroid/widget/ImageView;)V
    ...
    new-instance p1, Lgcash/common_presentation/utility/UiHelper$b;

    invoke-direct {p1, p2}, Lgcash/common_presentation/utility/UiHelper$b;-><init>(Landroid/widget/ImageView;)V
...
.method public static setBgImageView(Landroid/content/Context;Ljava/lang/String;Landroid/widget/ImageView;)V
    ...
    new-instance p1, Lgcash/common_presentation/utility/UiHelper$f;

    invoke-direct {p1, p2}, Lgcash/common_presentation/utility/UiHelper$f;-><init>(Landroid/widget/ImageView;)V
...
.method public static setBgImageView(Landroid/content/Context;Ljava/lang/String;Landroid/widget/ImageView;I)V
    ...
    new-instance p1, Lgcash/common_presentation/utility/UiHelper$h;

    invoke-direct {p1, p2}, Lgcash/common_presentation/utility/UiHelper$h;-><init>(Landroid/widget/ImageView;)V
...
.method public static setBgImageView(Landroid/content/Context;Ljava/lang/String;Landroid/widget/ImageView;Lcom/bumptech/glide/request/RequestListener;)V
    ...
    new-instance p1, Lgcash/common_presentation/utility/UiHelper$i;

    invoke-direct {p1, p2}, Lgcash/common_presentation/utility/UiHelper$i;-><init>(Landroid/widget/ImageView;)V
...
.method public static setBgImageViewCircular(Landroid/content/Context;Ljava/lang/String;ILandroid/widget/ImageView;)V
    ...
    .line 45
    new-instance p2, Lgcash/common_presentation/utility/UiHelper$a;

    .line 46
    .line 47
    invoke-direct {p2, p3, p0, p3}, Lgcash/common_presentation/utility/UiHelper$a;-><init>(Landroid/widget/ImageView;Landroid/content/Context;Landroid/widget/ImageView;)V
...
.method public static setBgImageViewDashboard(Landroid/content/Context;ILandroid/widget/ImageView;)V
    ...
    .line 49
    new-instance v3, Lgcash/common_presentation/utility/UiHelper$d;

    .line 50
    .line 51
    invoke-direct {v3, p2}, Lgcash/common_presentation/utility/UiHelper$d;-><init>(Landroid/widget/ImageView;)V
    ...
    .line 81
    new-instance p1, Lgcash/common_presentation/utility/UiHelper$e;

    .line 82
    .line 83
    invoke-direct {p1, p2}, Lgcash/common_presentation/utility/UiHelper$e;-><init>(Landroid/widget/ImageView;)V
...
.method public static setBgImageViewGIFSupport(Landroid/content/Context;Ljava/lang/String;ILandroid/widget/ImageView;)V
    ...
    .line 1
    new-instance v0, Lgcash/common_presentation/utility/UiHelper$j;

    invoke-direct {v0}, Lgcash/common_presentation/utility/UiHelper$j;-><init>()V

    .line 2
    invoke-static {p0, p1, p2, p3, v0}, Lgcash/common_presentation/utility/UiHelper;->setBgImageViewGIFSupport(Landroid/content/Context;Ljava/lang/String;ILandroid/widget/ImageView;Lcom/bumptech/glide/request/RequestListener;)V
...
.method public static setBgImageViewSVG(Landroid/content/Context;Ljava/lang/String;Landroid/widget/ImageView;I)V
    .locals 3
    ...
    .line 6
    .line 7
    invoke-static {v1, p0}, Lcom/bumptech/glide/Glide;->buildStreamModelLoader(Ljava/lang/Class;Landroid/content/Context;)Lcom/bumptech/glide/load/model/ModelLoader;
    ...
    .line 12
    .line 13
    invoke-virtual {v0, p0, v2}, Lcom/bumptech/glide/RequestManager;->using(Lcom/bumptech/glide/load/model/ModelLoader;Ljava/lang/Class;)Lcom/bumptech/glide/RequestManager$GenericModelRequest;
    ...
    .line 17
    invoke-virtual {p0, v1}, Lcom/bumptech/glide/RequestManager$GenericModelRequest;->from(Ljava/lang/Class;)Lcom/bumptech/glide/RequestManager$GenericModelRequest$GenericTypeRequest;
    ...
    .line 22
    .line 23
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/RequestManager$GenericModelRequest$GenericTypeRequest;->as(Ljava/lang/Class;)Lcom/bumptech/glide/GenericTranscodeRequest;
    ...
    .line 27
    new-instance v0, Lgcash/common_presentation/utility/svg/SvgDrawableTranscoder;

    .line 28
    .line 29
    invoke-direct {v0}, Lgcash/common_presentation/utility/svg/SvgDrawableTranscoder;-><init>()V
    ...
    .line 33
    .line 34
    invoke-virtual {p0, v0, v1}, Lcom/bumptech/glide/GenericTranscodeRequest;->transcode(Lcom/bumptech/glide/load/resource/transcode/ResourceTranscoder;Ljava/lang/Class;)Lcom/bumptech/glide/GenericRequestBuilder;
    ...
    .line 42
    .line 43
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/GenericRequestBuilder;->sourceEncoder(Lcom/bumptech/glide/load/Encoder;)Lcom/bumptech/glide/GenericRequestBuilder;
    ...
    .line 48
    .line 49
    new-instance v1, Lgcash/common_presentation/utility/svg/SvgDecoder;

    .line 50
    .line 51
    invoke-direct {v1}, Lgcash/common_presentation/utility/svg/SvgDecoder;-><init>()V
    ...
    .line 56
    .line 57
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/GenericRequestBuilder;->cacheDecoder(Lcom/bumptech/glide/load/ResourceDecoder;)Lcom/bumptech/glide/GenericRequestBuilder;
    ...
    .line 61
    new-instance v0, Lgcash/common_presentation/utility/svg/SvgDecoder;

    .line 62
    .line 63
    invoke-direct {v0}, Lgcash/common_presentation/utility/svg/SvgDecoder;-><init>()V
    ...
    .line 70
    invoke-virtual {p0, p3}, Lcom/bumptech/glide/GenericRequestBuilder;->placeholder(I)Lcom/bumptech/glide/GenericRequestBuilder;
    ...
    .line 75
    .line 76
    invoke-virtual {p0, p3}, Lcom/bumptech/glide/GenericRequestBuilder;->animate(I)Lcom/bumptech/glide/GenericRequestBuilder;
    ...
    .line 80
    new-instance p3, Lgcash/common_presentation/utility/svg/SvgSoftwareLayerSetter;

    .line 81
    .line 82
    invoke-direct {p3}, Lgcash/common_presentation/utility/svg/SvgSoftwareLayerSetter;-><init>()V

    .line 83
    .line 84
    .line 85
    invoke-virtual {p0, p3}, Lcom/bumptech/glide/GenericRequestBuilder;->listener(Lcom/bumptech/glide/request/RequestListener;)Lcom/bumptech/glide/GenericRequestBuilder;
    ...
    .line 94
    .line 95
    invoke-virtual {p0, p3}, Lcom/bumptech/glide/GenericRequestBuilder;->diskCacheStrategy(Lcom/bumptech/glide/load/engine/DiskCacheStrategy;)Lcom/bumptech/glide/GenericRequestBuilder;
    ...
    .line 99
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/GenericRequestBuilder;->load(Ljava/lang/Object;)Lcom/bumptech/glide/GenericRequestBuilder;
    ...
    .line 103
    invoke-virtual {p0, p2}, Lcom/bumptech/glide/GenericRequestBuilder;->into(Landroid/widget/ImageView;)Lcom/bumptech/glide/request/target/Target;
...
.method public static setBgImageViewURI(Landroid/content/Context;Ljava/lang/String;Landroid/widget/ImageView;)V
    ...
    .line 47
    new-instance p1, Lgcash/common_presentation/utility/UiHelper$g;

    .line 48
    .line 49
    invoke-direct {p1, p2}, Lgcash/common_presentation/utility/UiHelper$g;-><init>(Landroid/widget/ImageView;)V
