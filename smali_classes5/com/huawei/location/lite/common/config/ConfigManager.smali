...
.method private a(Lcom/huawei/location/lite/common/util/PreferencesHelper;)Z
    .locals 6
...
.method private b()V
    ...
    invoke-direct {p0, v0}, Lcom/huawei/location/lite/common/config/ConfigManager;->a(Lcom/huawei/location/lite/common/util/PreferencesHelper;)Z
    ...
    :cond_2
    invoke-direct {p0, v0}, Lcom/huawei/location/lite/common/config/ConfigManager;->d(Lcom/huawei/location/lite/common/util/PreferencesHelper;)V

    iget-object v0, p0, Lcom/huawei/location/lite/common/config/ConfigManager;->a:Ljava/util/HashMap;

    if-nez v0, :cond_3

    const-string v0, "84653"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "84654"
...
.method private c(Ljava/lang/String;)V
    ...
    :catch_0
    const-string v1, "84655"

    invoke-static/range {v1 .. v1}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "84656"
...
.method private d(Lcom/huawei/location/lite/common/util/PreferencesHelper;)V
    .locals 3
...
.method private e()Ljava/lang/String;
    ...
    const-string v2, "84664"

    invoke-static/range {v2 .. v2}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string v3, "84665"
...
.method public static getInstance()Lcom/huawei/location/lite/common/config/ConfigManager;
    ...
    invoke-static {}, Lcom/huawei/location/lite/common/config/ConfigManager$Vw;->a()Lcom/huawei/location/lite/common/config/ConfigManager;
...
.method public declared-synchronized requestConfigSync()V
    ...
    :try_start_0
    const-string v0, "84681"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "84682"
    ...
    const-string v0, "84683"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "84684"
    ...
    :cond_2
    :try_start_1
    invoke-direct {p0}, Lcom/huawei/location/lite/common/config/ConfigManager;->e()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/huawei/location/lite/common/config/ConfigManager;->c(Ljava/lang/String;)V
    ...
    :catch_0
    :try_start_2
    const-string v0, "84685"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "84686"
