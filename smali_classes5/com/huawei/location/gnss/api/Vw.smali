...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/huawei/location/gnss/api/Vw;->a:Landroid/location/LocationManager;

    :cond_2
    return-void
.end method

.method private a(Landroid/location/LocationListener;Lcom/huawei/hms/location/LocationRequest;Ljava/lang/String;JF)V
    .locals 15
    ...
    iget-object v3, v2, Lcom/huawei/location/gnss/api/Vw;->a:Landroid/location/LocationManager;
...
.method private b(Ljava/lang/String;JFLandroid/location/LocationListener;)V
    .locals 10
    ...
    :try_start_0
    iget-object v3, p0, Lcom/huawei/location/gnss/api/Vw;->a:Landroid/location/LocationManager;
...
.method public declared-synchronized yn(Landroid/location/LocationListener;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/huawei/location/gnss/api/Vw;->a:Landroid/location/LocationManager;
...
.method public declared-synchronized yn(Lcom/huawei/hms/support/api/entity/location/updates/RequestLocationUpdatesRequest;Landroid/location/LocationListener;)V
    ...
    const-string/jumbo p2, "requestLocationFromNative, illegal argument"
    ...
    :try_start_3
    invoke-direct/range {v0 .. v6}, Lcom/huawei/location/gnss/api/Vw;->a(Landroid/location/LocationListener;Lcom/huawei/hms/location/LocationRequest;Ljava/lang/String;JF)V
    :try_end_3
    ...
    const-string/jumbo p2, "requestLocationByNative other exception"
    ...
    const-string/jumbo p2, "requestLocationByNative SecurityException"

    goto :goto_2

    :catch_2
    const-string v0, "86946"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "86947"
    ...
    invoke-direct/range {v3 .. v8}, Lcom/huawei/location/gnss/api/Vw;->b(Ljava/lang/String;JFLandroid/location/LocationListener;)V

    goto :goto_4

    :catch_3
    const-string v0, "86948"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "86949"
    ...
    :catch_4
    const-string v0, "86950"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "86951"
    ...
    :catch_5
    const-string v0, "86952"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "86953"
    ...
    :catch_6
    const-string v0, "86954"

    invoke-static/range {v0 .. v0}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "86955"
