...
.method public a(Landroid/location/Location;Ljava/lang/String;)Lcom/huawei/hmf/tasks/Task;
    ...
    new-instance v1, Lcom/huawei/hms/locationSdk/c1;

    const-string v4, "80881"

    invoke-static/range {v4 .. v4}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-direct {v1, v4, p2, v2}, Lcom/huawei/hms/locationSdk/c1;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Ljava/lang/String;)Lcom/huawei/hmf/tasks/Task;
    ...
    new-instance v2, Lcom/huawei/hms/support/api/entity/location/stationrecognition/RequestStationRecognitionReq;

    invoke-virtual {p0}, Lcom/huawei/hms/common/HuaweiApi;->getContext()Landroid/content/Context;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/RequestStationRecognitionReq;-><init>(Landroid/content/Context;)V
    ...
    check-cast p1, Lcom/huawei/hms/support/api/entity/location/stationrecognition/StationRequest;

    invoke-direct {p0, p1}, Lcom/huawei/hms/locationSdk/k;->a(Lcom/huawei/hms/support/api/entity/location/stationrecognition/StationRequest;)V

    invoke-virtual {p0}, Lcom/huawei/hms/common/HuaweiApi;->getContext()Landroid/content/Context;

    move-result-object v4

    const-string v5, "80889"
    ...
    invoke-virtual {v2, v4}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/RequestStationRecognitionReq;->setAppId(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/StationRequest;->getAuthentication()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2, v4}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/RequestStationRecognitionReq;->setAuthentication(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/StationRequest;->getProjectId()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2, v4}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/RequestStationRecognitionReq;->setProjectId(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v4}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/RequestStationRecognitionReq;->setType(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/StationRequest;->getProxyAppId()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2, v4}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/RequestStationRecognitionReq;->setProxyAppId(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/StationRequest;->getOperation()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v2, p1}, Lcom/huawei/hms/support/api/entity/location/stationrecognition/RequestStationRecognitionReq;->setOperation(Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/huawei/hms/locationSdk/d1;

    const-string v4, "80891"

    invoke-static/range {v4 .. v4}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v4, p1, v3}, Lcom/huawei/hms/locationSdk/d1;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v2}, Lcom/huawei/hms/locationSdk/k;->doWrite(Lcom/huawei/hms/common/internal/TaskApiCall;)Lcom/huawei/hmf/tasks/Task;
...
.method public doWrite(Lcom/huawei/hms/common/internal/TaskApiCall;)Lcom/huawei/hmf/tasks/Task;
    ...
    iget-object v0, p0, Lcom/huawei/hms/locationSdk/k;->a:Lcom/huawei/hms/locationSdk/g1;
    ...
    iput-object v0, p0, Lcom/huawei/hms/locationSdk/k;->a:Lcom/huawei/hms/locationSdk/g1;
