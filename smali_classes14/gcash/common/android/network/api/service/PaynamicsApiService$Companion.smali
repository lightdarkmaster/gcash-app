.class public final Lgcash/common/android/network/api/service/PaynamicsApiService$Companion;
...
# static fields
.field static final synthetic $$INSTANCE:Lgcash/common/android/network/api/service/PaynamicsApiService$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lgcash/common/android/network/api/service/PaynamicsApiService$Companion;

    invoke-direct {v0}, Lgcash/common/android/network/api/service/PaynamicsApiService$Companion;-><init>()V

    sput-object v0, Lgcash/common/android/network/api/service/PaynamicsApiService$Companion;->$$INSTANCE:Lgcash/common/android/network/api/service/PaynamicsApiService$Companion;
...
# virtual methods
.method public final create()Lgcash/common/android/network/api/service/PaynamicsApiService;
    .locals 9
    ...
    .line 39
    new-instance v5, Lgcash/common/android/application/cache/PaynamicsConfig;

    invoke-direct {v5}, Lgcash/common/android/application/cache/PaynamicsConfig;-><init>()V
    ...
    invoke-virtual {v4, v3, v6}, Lgcash/common/android/network/SecurityInterceptor;->generate([B[B)Ljava/lang/String;
    ...
    .line 44
    invoke-virtual {v5}, Lgcash/common/android/application/cache/PaynamicsConfig;->getIpAddress()Ljava/lang/String;
    ...
    .line 45
    sget-object v4, Lgcash/common/android/application/util/UserAgent;->INSTANCE:Lgcash/common/android/application/util/UserAgent;

    invoke-virtual {v4}, Lgcash/common/android/application/util/UserAgent;->getAppVersion()Ljava/lang/String;

    move-result-object v4

    const-string v5, "130331"
    ...
    const-string v5, "130332"

    invoke-static/range {v5 .. v5}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    const-string v7, "130333"
    ...
    .line 51
    invoke-static {v6}, Lgcash/common/android/network/RiskEnvRequirements;->toBase64(Ljava/util/Map;)Ljava/lang/String;
    ...
    const-class v1, Lgcash/common/android/network/api/service/PaynamicsApiService;
    ...
    check-cast v0, Lgcash/common/android/network/api/service/PaynamicsApiService;

    return-object v0
.end method

.method public final create(Landroid/content/Context;)Lgcash/common/android/network/api/service/PaynamicsApiService;
    .locals 8
    ...
    invoke-virtual {v3, v2, v5}, Lgcash/common/android/network/SecurityInterceptor;->generate([B[B)Ljava/lang/String;
    ...
    .line 13
    sget-object v3, Lgcash/common/android/application/util/UserAgent;->INSTANCE:Lgcash/common/android/application/util/UserAgent;

    invoke-virtual {v3}, Lgcash/common/android/application/util/UserAgent;->getAppVersion()Ljava/lang/String;

    move-result-object v3

    const-string v4, "130348"
    ...
    const-string v4, "130349"

    invoke-static/range {v4 .. v4}, Lruntime/Strings/StringIndexer;->_getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    const-string v6, "130350"
    ...
    .line 19
    invoke-static {v5}, Lgcash/common/android/network/RiskEnvRequirements;->toBase64(Ljava/util/Map;)Ljava/lang/String;
    ...
    const-class v0, Lgcash/common/android/network/api/service/PaynamicsApiService;
    ...
    check-cast p1, Lgcash/common/android/network/api/service/PaynamicsApiService;
