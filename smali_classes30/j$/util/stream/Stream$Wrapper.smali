...
.method public static synthetic convert(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    :cond_2
    instance-of v0, p0, Lj$/util/stream/R2;

    if-eqz v0, :cond_3

    check-cast p0, Lj$/util/stream/R2;

    iget-object p0, p0, Lj$/util/stream/R2;->a:Ljava/util/stream/Stream;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->m(Lj$/util/function/Function;)Lj$/util/stream/DoubleStream;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->W(Lj$/util/function/Function;)Lj$/util/stream/LongStream;
...
.method public final synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->F(Lj$/util/function/ToIntFunction;)Lj$/util/stream/IntStream;
...
.method public final synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->c0(Lj$/util/function/ToLongFunction;)Lj$/util/stream/LongStream;
...
.method public final synthetic peek(Ljava/util/function/Consumer;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->s(Lj$/util/function/Consumer;)Lj$/util/stream/Stream;
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lj$/util/function/b;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/util/function/b;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/function/b;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->H(Lj$/util/function/BinaryOperator;)Lj$/util/Optional;
