...
.method public static final appendingSink(Ljava/io/File;)Lokio/Sink;
    ...
    invoke-static {p0}, Lokio/m;->b(Ljava/io/File;)Lokio/Sink;
...
.method public static final asResourceFileSystem(Ljava/lang/ClassLoader;)Lokio/FileSystem;
    ...
    invoke-static {p0}, Lokio/m;->c(Ljava/lang/ClassLoader;)Lokio/FileSystem;
...
.method public static final blackhole()Lokio/Sink;
    ...
    invoke-static {}, Lokio/n;->a()Lokio/Sink;
...
.method public static final buffer(Lokio/Sink;)Lokio/BufferedSink;
    ...
    .line 1
    invoke-static {p0}, Lokio/n;->b(Lokio/Sink;)Lokio/BufferedSink;
...
.method public static final buffer(Lokio/Source;)Lokio/BufferedSource;
    ...
    .line 2
    invoke-static {p0}, Lokio/n;->c(Lokio/Source;)Lokio/BufferedSource;
...
.method public static final cipherSink(Lokio/Sink;Ljavax/crypto/Cipher;)Lokio/CipherSink;
    ...
    invoke-static {p0, p1}, Lokio/m;->d(Lokio/Sink;Ljavax/crypto/Cipher;)Lokio/CipherSink;
...
.method public static final cipherSource(Lokio/Source;Ljavax/crypto/Cipher;)Lokio/CipherSource;
    ...
    invoke-static {p0, p1}, Lokio/m;->e(Lokio/Source;Ljavax/crypto/Cipher;)Lokio/CipherSource;
...
.method public static final hashingSink(Lokio/Sink;Ljava/security/MessageDigest;)Lokio/HashingSink;
    ...
    .line 1
    invoke-static {p0, p1}, Lokio/m;->f(Lokio/Sink;Ljava/security/MessageDigest;)Lokio/HashingSink;
...
.method public static final hashingSink(Lokio/Sink;Ljavax/crypto/Mac;)Lokio/HashingSink;
    ...
    .line 2
    invoke-static {p0, p1}, Lokio/m;->g(Lokio/Sink;Ljavax/crypto/Mac;)Lokio/HashingSink;
...
.method public static final hashingSource(Lokio/Source;Ljava/security/MessageDigest;)Lokio/HashingSource;
    ...
    .line 1
    invoke-static {p0, p1}, Lokio/m;->h(Lokio/Source;Ljava/security/MessageDigest;)Lokio/HashingSource;
...
.method public static final hashingSource(Lokio/Source;Ljavax/crypto/Mac;)Lokio/HashingSource;
    ...
    .line 2
    invoke-static {p0, p1}, Lokio/m;->i(Lokio/Source;Ljavax/crypto/Mac;)Lokio/HashingSource;
...
.method public static final isAndroidGetsocknameError(Ljava/lang/AssertionError;)Z
    ...
    invoke-static {p0}, Lokio/m;->j(Ljava/lang/AssertionError;)Z
...
.method public static final openZip(Lokio/FileSystem;Lokio/Path;)Lokio/FileSystem;
    ...
    invoke-static {p0, p1}, Lokio/m;->k(Lokio/FileSystem;Lokio/Path;)Lokio/FileSystem;
...
.method public static final sink(Ljava/io/File;)Lokio/Sink;
    ...
    .line 1
    invoke-static {p0}, Lokio/m;->l(Ljava/io/File;)Lokio/Sink;
...
.method public static final sink(Ljava/io/File;Z)Lokio/Sink;
    ...
    .line 2
    invoke-static {p0, p1}, Lokio/m;->m(Ljava/io/File;Z)Lokio/Sink;
...
.method public static final sink(Ljava/io/OutputStream;)Lokio/Sink;
    ...
    .line 3
    invoke-static {p0}, Lokio/m;->n(Ljava/io/OutputStream;)Lokio/Sink;
...
.method public static final sink(Ljava/net/Socket;)Lokio/Sink;
    ...
    .line 4
    invoke-static {p0}, Lokio/m;->o(Ljava/net/Socket;)Lokio/Sink;
...
.method public static final varargs sink(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Sink;
    ...
    .line 5
    invoke-static {p0, p1}, Lokio/m;->p(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Sink;
...
.method public static synthetic sink$default(Ljava/io/File;ZILjava/lang/Object;)Lokio/Sink;
    ...
    invoke-static {p0, p1, p2, p3}, Lokio/m;->q(Ljava/io/File;ZILjava/lang/Object;)Lokio/Sink;
...
.method public static final source(Ljava/io/File;)Lokio/Source;
    ...
    .line 1
    invoke-static {p0}, Lokio/m;->r(Ljava/io/File;)Lokio/Source;
...
.method public static final source(Ljava/io/InputStream;)Lokio/Source;
    ...
    .line 2
    invoke-static {p0}, Lokio/m;->s(Ljava/io/InputStream;)Lokio/Source;
...
.method public static final source(Ljava/net/Socket;)Lokio/Source;
    ...
    .line 3
    invoke-static {p0}, Lokio/m;->t(Ljava/net/Socket;)Lokio/Source;
...
.method public static final varargs source(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Source;
    ...
    .line 4
    invoke-static {p0, p1}, Lokio/m;->u(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Source;
...
.method public static final use(Ljava/io/Closeable;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lokio/n;->d(Ljava/io/Closeable;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
